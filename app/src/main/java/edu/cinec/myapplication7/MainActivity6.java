...
public class MainActivity6 extends AppCompatActivity {
    ...
    EditText input3,input4,input5,input6;
    Button btn;
    TextView text_3,text_4,text_5,text_6,text_7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input4 = findViewById(R.id.inpu4);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                float con3 = Float.parseFloat(input6.getText().toString());
                float ans = con+con2+con1+con3;
